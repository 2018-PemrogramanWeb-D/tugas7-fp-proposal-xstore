...
<body>
                                        ...
                                        <li>
                                            <div class="navbar-logout">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <p class="text-left nama-bawah"><strong>
    ...
    <div class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1>Terima Kasih Telah Berbelanja di XStore</h1>
                </div>
            </div>
            <div class="form-group">
                <button type="submit" name="submit" id="loginSubmit" class="btn btn-success loginFormElement" onclick="location.href='home.php'">Go Back
                    Home</button>
            </div>
            </form>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <p class="mb-2"> <span class="ti-location-pin mr-2"></span> Jl. Teknik Kimia - Gedung Teknik
                        Informatika</p>
